...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add 𝐸𝒹𝓌𝒶𝓇𝒹 to your group 💫", url="t.me/sledward_bot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/3bb54232d65b42d7a288a.jpg)
...
Support them  [𝓘𝓼𝓲𝓻𝓪](@IsiRAPiumaTH)"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [𝓢𝓵 𝓟𝓬 𝓖𝓪𝓶𝓮𝓼](https://t.me/slpcgame) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/e4888d7e2d90d7d4e70da.png)"
